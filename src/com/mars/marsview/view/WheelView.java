...
import com.mars.marsview.interfaceutils.ItemsRange;
import com.mars.marsview.interfaceutils.OnWheelChangedListener;
import com.mars.marsview.interfaceutils.OnWheelClickedListener;
import com.mars.marsview.interfaceutils.OnWheelScrollListener;
import com.mars.marsview.interfaceutils.WheelRecycle;
import com.mars.marsview.interfaceutils.WheelScroller;
...
public class WheelView extends View {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (heightMode == MeasureSpec.EXACTLY) {
			...
			height = getDesiredHeight(itemsLayout)+PADDING;
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.bgblur));
		// 设置线宽
