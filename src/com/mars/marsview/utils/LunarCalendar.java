...
public class LunarCalendar {
	 ...
	 * 获取计算出的农历日期 年、月、日
	 *ymd 1、年月日 2、月日
	 *time 2016年09月23日11:16:11
	 */
	public static String getLunar(int ymd,String time) {
		int[] date = LunarCalendar.solarToLunar(
		...
		if(ymd==1){
			sb.append(date[0]).append("年").append(LunarCalendar.lunarMonth(date[1])).append("月")
			.append(LunarCalendar.lunarDay(date[2]));
		}else{
			sb.append(LunarCalendar.lunarMonth(date[1])).append("月").append(LunarCalendar.lunarDay(date[2]));
		}
		return sb.toString();
	}

	public static String lunarDay(int dayIndex) {
	...
	public static String lunarMonth(int monthIndex) {
